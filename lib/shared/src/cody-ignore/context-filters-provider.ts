...
export class ContextFiltersProvider implements vscode.Disposable {
    ...
    public async isUriIgnored(uri: vscode.Uri): Promise<IsIgnored> {
        ...
        // }
        // const repoNames = await wrapInActiveSpan('repoNameResolver.getRepoNamesFromWorkspaceUri', (span) => {
...
// function parseContextFilterItem(item: DriverContextFilterItem): ParsedContextFilterItem {
